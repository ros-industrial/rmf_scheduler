...
#ifndef RMF_SCHEDULER__RUNTIME__SYSTEM_TIME_EXECUTOR_HPP_
#define RMF_SCHEDULER__RUNTIME__SYSTEM_TIME_EXECUTOR_HPP_
...
public:
  ...
  void add_action(const data::Event & event, Action action);
...
#endif  // RMF_SCHEDULER__RUNTIME__SYSTEM_TIME_EXECUTOR_HPP_
