...
#ifndef RMF_SCHEDULER__DAG_EXECUTOR_HPP_
#define RMF_SCHEDULER__DAG_EXECUTOR_HPP_
...
public:
  ...
  std::shared_future<void> run(DAG &, WorkGenerator &);
...
#endif  // RMF_SCHEDULER__DAG_EXECUTOR_HPP_
